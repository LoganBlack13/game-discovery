<x-layouts.app title="Page not found">
    <div class="flex min-h-[60vh] flex-col items-center justify-center px-4 py-16 text-center">
        <p class="font-display text-8xl font-bold text-base-content/20">404</p>
        <h1 class="mt-4 font-display text-2xl font-semibold text-base-content">Page not found</h1>
