...
final class GameFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'genres' => fake()->randomElements(['RPG', 'Action', 'Adventure', 'Strategy', 'Racing', 'Shooter', 'Puzzle'], (int) fake()->numberBetween(1, 3)),
            'platforms' => fake()->randomElements(['PC', 'PlayStation', 'Xbox', 'Switch'], (int) fake()->numberBetween(1, 3)),
